...
export default class OfferModule extends Component {
  state = {
      visibleModal: null,
  };
  
  renderButton = (onPress, id, title, type, location, pictureUrl) => (
      ...
      <View>
        <View style={styles.topRow}>
            <Card style={styles.cardStyle}>
                {this.renderButton( () => this.setState({ visibleModal: 1}), myId, myTitle, myType, myLocation, myPictureUrl )}
            </Card>
        </View>
        <View>
